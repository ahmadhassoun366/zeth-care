...
export class FileSizeTooLargeError extends CustomError {
	constructor() {
		super('File size is too large', 800);
	}
}

export class FileInvalidTypeError extends CustomError {
	constructor() {
		super('This file format is not supported', 801);
	}
}

export class PwrProviderNotDetectedError extends CustomError {
	constructor() {
		super('Provider not detected', ERROR_CODES.PWR_PROVIDER_NOT_DETECTED);
	}
}
